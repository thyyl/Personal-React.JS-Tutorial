    ...
    return (  
        <div className="create">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" required name="title" value={values.title} onChange={handleChange}/>
                <label>Blog Body: </label>
                <textarea required name="body" value={values.body} onChange={handleChange}></textarea>
